...
import Blueprints.handler_convertions as conversion_handler
import Blueprints.services.conversions.upload_flow.job_submission as job_submission
from Blueprints.services.conversions.job_queue import process_conversion_job
...
def patch_job_queue(app):
    def submit_sync(flask_app, job_id, convert_function, usage_id=None):
        process_conversion_job(app, job_id, convert_function, usage_id)
