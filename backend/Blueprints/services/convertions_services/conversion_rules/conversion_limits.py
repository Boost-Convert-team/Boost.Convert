...
SPECIAL_ROUTE_EXTENSIONS = {"/convert/pdf-merge": ("pdf", "pdf"), "/convert/pdf-split": ("pdf", "zip"), "/convert/pdf-compress": ("pdf", "pdf"), "/convert/pdf-edit": ("pdf", "pdf"), "/convert/pdf-rotate": ("pdf", "pdf"), "/convert/pdf-protect": ("pdf", "pdf"), "/convert/pdf-unlock": ("pdf", "pdf"), "/convert/pdf-extract-images": ("pdf", "zip"), "/convert/pdf-ocr-searchable": ("pdf", "pdf"), "/convert/files-to-zip": ("zip", "zip"), "/convert/images-to-pdf": ("jpg", "pdf"), "/convert/image-ocr-to-txt": ("jpg", "txt"), "/convert/pdf-ocr-to-txt": ("pdf", "txt")}
