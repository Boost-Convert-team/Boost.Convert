"""add Stripe recurring billing data without deleting historical payments
...
def upgrade():
    with op.batch_alter_table("usuarios") as batch_op:
        ...
        batch_op.create_index(
            "ix_usuarios_stripe_customer_id", ["stripe_customer_id"], unique=True
        )
    ...
    with op.batch_alter_table("subscriptions") as batch_op:
        ...
        batch_op.create_index(
            "ix_subscriptions_stripe_price_id", ["stripe_price_id"], unique=False
        )
        batch_op.create_index(
